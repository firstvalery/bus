...
public class ConductorScheduleRecord extends UpdatableRecordImpl<ConductorScheduleRecord> implements Record5<Short, Date, Short, Short, Short> {

    private static final long serialVersionUID = -2082784423;
     ...
     */
    @Override
    public ConductorScheduleRecord values(Short value1, Date value2, Short value3, Short value4, Short value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ConductorScheduleRecord(Short conductorId, Date date, Short shiftTypeId, Short readyTypeId, Short removed) {
        super(ConductorSchedule.CONDUCTOR_SCHEDULE);
