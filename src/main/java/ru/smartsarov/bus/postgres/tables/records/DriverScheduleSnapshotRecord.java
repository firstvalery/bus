...
public class DriverScheduleSnapshotRecord extends UpdatableRecordImpl<DriverScheduleSnapshotRecord> implements Record7<Short, Date, Short, Short, OffsetDateTime, OffsetDateTime, Short> {

    private static final long serialVersionUID = 1108078267;
     ...
     */
    @Override
    public DriverScheduleSnapshotRecord values(Short value1, Date value2, Short value3, Short value4, OffsetDateTime value5, OffsetDateTime value6, Short value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DriverScheduleSnapshotRecord(Short employeeId, Date date, Short shiftTypeId, Short readyTypeId, OffsetDateTime createdAt, OffsetDateTime endedAt, Short removed) {
        super(DriverScheduleSnapshot.DRIVER_SCHEDULE_SNAPSHOT);
