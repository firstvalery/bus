...
public class ShiftDepartureMomentsRecord extends UpdatableRecordImpl<ShiftDepartureMomentsRecord> implements Record5<Integer, Short, Integer, Short, Short> {

    private static final long serialVersionUID = 1346645817;
     ...
     */
    public void setDepartureMomentsId(Integer value) {
        set(2, value);
    }
     ...
     */
    public Integer getDepartureMomentsId() {
     ...
     */
    @Override
    public Row5<Integer, Short, Integer, Short, Short> fieldsRow() {
     ...
     */
    @Override
    public Row5<Integer, Short, Integer, Short, Short> valuesRow() {
     ...
     */
    @Override
    public ShiftDepartureMomentsRecord value3(Integer value) {
     ...
     */
    @Override
    public ShiftDepartureMomentsRecord values(Integer value1, Short value2, Integer value3, Short value4, Short value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ShiftDepartureMomentsRecord(Integer id, Short shiftDepartureListId, Integer departureMomentsId, Short order, Short removed) {
        super(ShiftDepartureMoments.SHIFT_DEPARTURE_MOMENTS);
