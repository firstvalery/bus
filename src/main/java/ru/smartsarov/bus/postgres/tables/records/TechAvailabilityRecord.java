...
public class TechAvailabilityRecord extends UpdatableRecordImpl<TechAvailabilityRecord> implements Record4<Integer, Date, Short, Short> {

    private static final long serialVersionUID = -1520774869;
     ...
     */
    @Override
    public Row4<Integer, Date, Short, Short> fieldsRow() {
     ...
     */
    @Override
    public Row4<Integer, Date, Short, Short> valuesRow() {
     ...
     */
    @Override
    public TechAvailabilityRecord value1(Integer value) {
        setBusId(value);
        return this;
    }
     ...
     */
    @Override
    public TechAvailabilityRecord values(Integer value1, Date value2, Short value3, Short value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TechAvailabilityRecord(Integer busId, Date date, Short busConditionId, Short removed) {
        super(TechAvailability.TECH_AVAILABILITY);
