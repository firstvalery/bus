...
public class DriverScheduleRecord extends UpdatableRecordImpl<DriverScheduleRecord> implements Record5<Short, Date, Short, Short, Short> {

    private static final long serialVersionUID = 871079618;

    /**
     * Setter for <code>public.driver_schedule.employee_id</code>.
     */
    ...
    /**
     * Getter for <code>public.driver_schedule.employee_id</code>.
     */
    ...
    /**
     * Setter for <code>public.driver_schedule.schedule_type_id</code>.
     */
    public void setScheduleTypeId(Short value) {
        set(2, value);
    }

    /**
     * Getter for <code>public.driver_schedule.schedule_type_id</code>.
     */
    ...
    public Field<Short> field1() {
        return DriverSchedule.DRIVER_SCHEDULE.EMPLOYEE_ID;
    }
    ...
    public Field<Short> field3() {
        return DriverSchedule.DRIVER_SCHEDULE.SCHEDULE_TYPE_ID;
    }
     ...
     */
    @Override
    public DriverScheduleRecord value1(Short value) {
        setEmployeeId(value);
        return this;
    }
     ...
     */
    @Override
    public DriverScheduleRecord values(Short value1, Date value2, Short value3, Short value4, Short value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DriverScheduleRecord(Short employeeId, Date date, Short scheduleTypeId, Short readyTypeId, Short removed) {
        super(DriverSchedule.DRIVER_SCHEDULE);

        set(0, employeeId);
        set(1, date);
        set(2, scheduleTypeId);
        set(3, readyTypeId);
        set(4, removed);
    }
}
