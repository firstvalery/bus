...
public class DriverScheduleRecord extends UpdatableRecordImpl<DriverScheduleRecord> implements Record4<Short, Date, Short, Short> {

    private static final long serialVersionUID = 1306525495;
     ...
     */
    @Override
    public DriverScheduleRecord values(Short value1, Date value2, Short value3, Short value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DriverScheduleRecord(Short employeeId, Date date, Short scheduleTypeId, Short removed) {
        super(DriverSchedule.DRIVER_SCHEDULE);
