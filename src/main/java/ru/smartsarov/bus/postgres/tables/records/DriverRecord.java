...
public class DriverRecord extends UpdatableRecordImpl<DriverRecord> implements Record10<Integer, Short, Short, Short, Boolean, Short, Short, Short, Boolean, Short> {

    private static final long serialVersionUID = 1417570665;
     ...
     */
    @Override
    public Row10<Integer, Short, Short, Short, Boolean, Short, Short, Short, Boolean, Short> fieldsRow() {
     ...
     */
    @Override
    public Row10<Integer, Short, Short, Short, Boolean, Short, Short, Short, Boolean, Short> valuesRow() {
     ...
     */
    @Override
    public DriverRecord value4(Short value) {
        setBusId(value);
        return this;
    }
     ...
     */
    @Override
    public DriverRecord values(Integer value1, Short value2, Short value3, Short value4, Boolean value5, Short value6, Short value7, Short value8, Boolean value9, Short value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DriverRecord(Integer id, Short employeeDataId, Short positionId, Short busId, Boolean brigadierFlag, Short groupId, Short scheduleType, Short stateId, Boolean ticketFlag, Short removed) {
        super(Driver.DRIVER);
