...
public class DriverRecord extends UpdatableRecordImpl<DriverRecord> implements Record10<Integer, Short, Short, Boolean, Short, Short, Short, Short, Boolean, Short> {

    private static final long serialVersionUID = 1942106892;
    ...
    /**
     * Setter for <code>public.driver.ready_type_id</code>.
     */
    ...
    /**
     * Getter for <code>public.driver.ready_type_id</code>.
     */
     ...
     */
    @Override
    public Row10<Integer, Short, Short, Boolean, Short, Short, Short, Short, Boolean, Short> fieldsRow() {
     ...
     */
    @Override
    public Row10<Integer, Short, Short, Boolean, Short, Short, Short, Short, Boolean, Short> valuesRow() {
    ...
    public Field<Short> field7() {
        return Driver.DRIVER.READY_TYPE_ID;
    }
     ...
     */
    @Override
    public DriverRecord value5(Short value) {
        setGroupId(value);
        return this;
    }
     ...
     */
    @Override
    public DriverRecord values(Integer value1, Short value2, Short value3, Boolean value4, Short value5, Short value6, Short value7, Short value8, Boolean value9, Short value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DriverRecord(Integer id, Short employeeDataId, Short busId, Boolean brigadierFlag, Short groupId, Short scheduleType, Short readyTypeId, Short stateId, Boolean ticketFlag, Short removed) {
        super(Driver.DRIVER);
