...
public class Keys {
    ...
    public static final ForeignKey<DriverScheduleRecord, DriverRecord> DRIVER_SCHEDULE__FK_DRIVER_SCHEDULE_TBL_DRIVER_ID_FK = ForeignKeys0.DRIVER_SCHEDULE__FK_DRIVER_SCHEDULE_TBL_DRIVER_ID_FK;
    public static final ForeignKey<DriverScheduleRecord, RbShiftTypeRecord> DRIVER_SCHEDULE__FK_DRIVER_SCHEDULE_TBL_SHIFT_TYPE_ID = ForeignKeys0.DRIVER_SCHEDULE__FK_DRIVER_SCHEDULE_TBL_SHIFT_TYPE_ID;
    ...
    public static final ForeignKey<DriverScheduleSnapshotRecord, DriverRecord> DRIVER_SCHEDULE_SNAPSHOT__FK_DRIVER_SCHEDULE_SNAPSHOT_TBL_DRIVER_ID = ForeignKeys0.DRIVER_SCHEDULE_SNAPSHOT__FK_DRIVER_SCHEDULE_SNAPSHOT_TBL_DRIVER_ID;
    ...
    public static final ForeignKey<ShiftScheduleRecord, RbShiftTypeRecord> SHIFT_SCHEDULE__FK_SHIFT_SCHEDULE_TBL_SHIFT_TYPE_ID = ForeignKeys0.SHIFT_SCHEDULE__FK_SHIFT_SCHEDULE_TBL_SHIFT_TYPE_ID;
    ...
    public static final ForeignKey<ShiftScheduleSnapshotRecord, RbShiftTypeRecord> SHIFT_SCHEDULE_SNAPSHOT__FK_SHIFT_SCHEDULE_SNAPSHOT_TBL_SHIFT_TYPE_ID = ForeignKeys0.SHIFT_SCHEDULE_SNAPSHOT__FK_SHIFT_SCHEDULE_SNAPSHOT_TBL_SHIFT_TYPE_ID;
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<DriverScheduleRecord> PK_DRIVER_SCHEDULE_TBL = Internal.createUniqueKey(DriverSchedule.DRIVER_SCHEDULE, "pk_driver_schedule_tbl", DriverSchedule.DRIVER_SCHEDULE.DRIVER_ID, DriverSchedule.DRIVER_SCHEDULE.DATE);
        public static final UniqueKey<DriverScheduleSnapshotRecord> PK_DRIVER_SCHEDULE_SNAPSHOT_TBL = Internal.createUniqueKey(DriverScheduleSnapshot.DRIVER_SCHEDULE_SNAPSHOT, "pk_driver_schedule_snapshot_tbl", DriverScheduleSnapshot.DRIVER_SCHEDULE_SNAPSHOT.DRIVER_ID, DriverScheduleSnapshot.DRIVER_SCHEDULE_SNAPSHOT.DATE, DriverScheduleSnapshot.DRIVER_SCHEDULE_SNAPSHOT.CREATED_AT);
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<DriverScheduleRecord, DriverRecord> DRIVER_SCHEDULE__FK_DRIVER_SCHEDULE_TBL_DRIVER_ID_FK = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_DRIVER_TBL_EMPLOYEE_SNAPSHOT_ID, DriverSchedule.DRIVER_SCHEDULE, "driver_schedule__fk_driver_schedule_tbl_driver_id_fk", DriverSchedule.DRIVER_SCHEDULE.DRIVER_ID);
        public static final ForeignKey<DriverScheduleRecord, RbShiftTypeRecord> DRIVER_SCHEDULE__FK_DRIVER_SCHEDULE_TBL_SHIFT_TYPE_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_SHIFT_TYPE_TBL, DriverSchedule.DRIVER_SCHEDULE, "driver_schedule__fk_driver_schedule_tbl_shift_type_id", DriverSchedule.DRIVER_SCHEDULE.SHIFT_TYPE_ID);
        ...
        public static final ForeignKey<DriverScheduleSnapshotRecord, DriverRecord> DRIVER_SCHEDULE_SNAPSHOT__FK_DRIVER_SCHEDULE_SNAPSHOT_TBL_DRIVER_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_DRIVER_TBL_EMPLOYEE_SNAPSHOT_ID, DriverScheduleSnapshot.DRIVER_SCHEDULE_SNAPSHOT, "driver_schedule_snapshot__fk_driver_schedule_snapshot_tbl_driver_id", DriverScheduleSnapshot.DRIVER_SCHEDULE_SNAPSHOT.DRIVER_ID);
        ...
        public static final ForeignKey<ShiftScheduleSnapshotRecord, RbShiftTypeRecord> SHIFT_SCHEDULE_SNAPSHOT__FK_SHIFT_SCHEDULE_SNAPSHOT_TBL_SHIFT_TYPE_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_SHIFT_TYPE_TBL, ShiftScheduleSnapshot.SHIFT_SCHEDULE_SNAPSHOT, "shift_schedule_snapshot__fk_shift_schedule_snapshot_tbl_shift_type_id", ShiftScheduleSnapshot.SHIFT_SCHEDULE_SNAPSHOT.SHIFT_TYPE_ID);
