...
public class Keys {
    ...
    public static final Identity<BusConditionRecord, Integer> IDENTITY_BUS_CONDITION = Identities0.IDENTITY_BUS_CONDITION;
    public static final Identity<BusDataRecord, Integer> IDENTITY_BUS_DATA = Identities0.IDENTITY_BUS_DATA;
    ...
    public static final Identity<EmployeeDataRecord, Integer> IDENTITY_EMPLOYEE_DATA = Identities0.IDENTITY_EMPLOYEE_DATA;
    ...
    public static final Identity<RbBusMakeRecord, Integer> IDENTITY_RB_BUS_MAKE = Identities0.IDENTITY_RB_BUS_MAKE;
    public static final Identity<RbBusModelRecord, Integer> IDENTITY_RB_BUS_MODEL = Identities0.IDENTITY_RB_BUS_MODEL;
    ...
    public static final UniqueKey<BusConditionRecord> PK_BUS_CONDITION_TBL = UniqueKeys0.PK_BUS_CONDITION_TBL;
    public static final UniqueKey<BusDataRecord> PK_BUS_DATA_TBL = UniqueKeys0.PK_BUS_DATA_TBL;
    public static final UniqueKey<BusDataRecord> UNIQ_BUS_DATA_TBL_VIN = UniqueKeys0.UNIQ_BUS_DATA_TBL_VIN;
    ...
    public static final UniqueKey<EmployeeDataRecord> PK_EMPLOYEE_DATA_TBL = UniqueKeys0.PK_EMPLOYEE_DATA_TBL;
    ...
    public static final ForeignKey<BusRecord, BusDataRecord> BUS__FK_BUS_TBL_BUS_ID = ForeignKeys0.BUS__FK_BUS_TBL_BUS_ID;
    ...
    public static final ForeignKey<BusRecord, BusConditionRecord> BUS__FK_BUS_TBL_CONDITION_ID = ForeignKeys0.BUS__FK_BUS_TBL_CONDITION_ID;
    public static final ForeignKey<BusDataRecord, RbBusMakeRecord> BUS_DATA__FK_BUS_DATA_TBL_BUS_MAKE = ForeignKeys0.BUS_DATA__FK_BUS_DATA_TBL_BUS_MAKE;
    public static final ForeignKey<BusDataRecord, RbBusModelRecord> BUS_DATA__FK_BUS_DATA_TBL_BUS_MODEL = ForeignKeys0.BUS_DATA__FK_BUS_DATA_TBL_BUS_MODEL;
    ...
    public static final ForeignKey<ConductorRecord, EmployeeDataRecord> CONDUCTOR__FK_CONDUCTOR_TBL_EMPLOYEE_DATA_ID = ForeignKeys0.CONDUCTOR__FK_CONDUCTOR_TBL_EMPLOYEE_DATA_ID;
    public static final ForeignKey<ConductorRecord, RbReadyTypeRecord> CONDUCTOR__FK_CONDUCTOR_TBL_READY_TYPE_ID_FK = ForeignKeys0.CONDUCTOR__FK_CONDUCTOR_TBL_READY_TYPE_ID_FK;
    ...
    public static final ForeignKey<ConductorSnapshotRecord, EmployeeDataRecord> CONDUCTOR_SNAPSHOT__FK_CONDUCTOR_SNAPSHOT_TBL_EMPLOYEE_DATA_ID = ForeignKeys0.CONDUCTOR_SNAPSHOT__FK_CONDUCTOR_SNAPSHOT_TBL_EMPLOYEE_DATA_ID;
    public static final ForeignKey<ConductorSnapshotRecord, RbReadyTypeRecord> CONDUCTOR_SNAPSHOT__FK_CONDUCTOR_SNAPSHOT_TBL_READY_TYPE_ID = ForeignKeys0.CONDUCTOR_SNAPSHOT__FK_CONDUCTOR_SNAPSHOT_TBL_READY_TYPE_ID;
    ...
    public static final ForeignKey<DriverRecord, EmployeeDataRecord> DRIVER__FK_DRIVER_TBL_EMPLOYEE_DATA_ID = ForeignKeys0.DRIVER__FK_DRIVER_TBL_EMPLOYEE_DATA_ID;
    ...
    public static final ForeignKey<DriverRecord, RbReadyTypeRecord> DRIVER__FK_DRIVER_TBL_READY_TYPE_ID = ForeignKeys0.DRIVER__FK_DRIVER_TBL_READY_TYPE_ID;
    ...
    public static final ForeignKey<DriverSnapshotRecord, EmployeeDataRecord> DRIVER_SNAPSHOT__FK_DRIVER_SNAPSHOT_TBL_EMPLOYEE_DATA_ID = ForeignKeys0.DRIVER_SNAPSHOT__FK_DRIVER_SNAPSHOT_TBL_EMPLOYEE_DATA_ID;
    ...
    public static final ForeignKey<DriverSnapshotRecord, RbReadyTypeRecord> DRIVER_SNAPSHOT__FK_DRIVER__SNAPSHOT_TBL_READY_TYPE_ID = ForeignKeys0.DRIVER_SNAPSHOT__FK_DRIVER__SNAPSHOT_TBL_READY_TYPE_ID;
    ...
    public static final ForeignKey<EmployeeDataRecord, RbEmployeeTypeRecord> EMPLOYEE_DATA__FK_EMPLOYEE_DATA_EMPLOYEE_TYPE_ID = ForeignKeys0.EMPLOYEE_DATA__FK_EMPLOYEE_DATA_EMPLOYEE_TYPE_ID;
    ...
    private static class Identities0 {
        ...
        public static Identity<BusConditionRecord, Integer> IDENTITY_BUS_CONDITION = Internal.createIdentity(BusCondition.BUS_CONDITION, BusCondition.BUS_CONDITION.ID);
        public static Identity<BusDataRecord, Integer> IDENTITY_BUS_DATA = Internal.createIdentity(BusData.BUS_DATA, BusData.BUS_DATA.ID);
        ...
        public static Identity<EmployeeDataRecord, Integer> IDENTITY_EMPLOYEE_DATA = Internal.createIdentity(EmployeeData.EMPLOYEE_DATA, EmployeeData.EMPLOYEE_DATA.ID);
        ...
        public static Identity<RbBusMakeRecord, Integer> IDENTITY_RB_BUS_MAKE = Internal.createIdentity(RbBusMake.RB_BUS_MAKE, RbBusMake.RB_BUS_MAKE.ID);
        public static Identity<RbBusModelRecord, Integer> IDENTITY_RB_BUS_MODEL = Internal.createIdentity(RbBusModel.RB_BUS_MODEL, RbBusModel.RB_BUS_MODEL.ID);
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<BusConditionRecord> PK_BUS_CONDITION_TBL = Internal.createUniqueKey(BusCondition.BUS_CONDITION, "pk_bus_condition_tbl", BusCondition.BUS_CONDITION.ID);
        public static final UniqueKey<BusDataRecord> PK_BUS_DATA_TBL = Internal.createUniqueKey(BusData.BUS_DATA, "pk_bus_data_tbl", BusData.BUS_DATA.ID);
        public static final UniqueKey<BusDataRecord> UNIQ_BUS_DATA_TBL_VIN = Internal.createUniqueKey(BusData.BUS_DATA, "uniq_bus_data_tbl_vin", BusData.BUS_DATA.VIN);
        ...
        public static final UniqueKey<EmployeeDataRecord> PK_EMPLOYEE_DATA_TBL = Internal.createUniqueKey(EmployeeData.EMPLOYEE_DATA, "pk_employee_data_tbl", EmployeeData.EMPLOYEE_DATA.ID);
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<BusRecord, BusDataRecord> BUS__FK_BUS_TBL_BUS_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_BUS_DATA_TBL, Bus.BUS, "bus__fk_bus_tbl_bus_id", Bus.BUS.BUS_ID);
        ...
        public static final ForeignKey<BusRecord, BusConditionRecord> BUS__FK_BUS_TBL_CONDITION_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_BUS_CONDITION_TBL, Bus.BUS, "bus__fk_bus_tbl_condition_id", Bus.BUS.CONDITION_ID);
        public static final ForeignKey<BusDataRecord, RbBusMakeRecord> BUS_DATA__FK_BUS_DATA_TBL_BUS_MAKE = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_RB_BUS_MAKE_TBL, BusData.BUS_DATA, "bus_data__fk_bus_data_tbl_bus_make", BusData.BUS_DATA.MAKE_ID);
        public static final ForeignKey<BusDataRecord, RbBusModelRecord> BUS_DATA__FK_BUS_DATA_TBL_BUS_MODEL = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_RB_BUS_MODEL_TBL, BusData.BUS_DATA, "bus_data__fk_bus_data_tbl_bus_model", BusData.BUS_DATA.MODEL_ID);
        ...
        public static final ForeignKey<ConductorRecord, EmployeeDataRecord> CONDUCTOR__FK_CONDUCTOR_TBL_EMPLOYEE_DATA_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_EMPLOYEE_DATA_TBL, Conductor.CONDUCTOR, "conductor__fk_conductor_tbl_employee_data_id", Conductor.CONDUCTOR.EMPLOYEE_DATA_ID);
        public static final ForeignKey<ConductorRecord, RbReadyTypeRecord> CONDUCTOR__FK_CONDUCTOR_TBL_READY_TYPE_ID_FK = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_RB_READY_TYPE_TBL, Conductor.CONDUCTOR, "conductor__fk_conductor_tbl_ready_type_id_fk", Conductor.CONDUCTOR.READY_TYPE_ID);
        ...
        public static final ForeignKey<ConductorSnapshotRecord, EmployeeDataRecord> CONDUCTOR_SNAPSHOT__FK_CONDUCTOR_SNAPSHOT_TBL_EMPLOYEE_DATA_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_EMPLOYEE_DATA_TBL, ConductorSnapshot.CONDUCTOR_SNAPSHOT, "conductor_snapshot__fk_conductor_snapshot_tbl_employee_data_id", ConductorSnapshot.CONDUCTOR_SNAPSHOT.EMPLOYEE_DATA_ID);
        public static final ForeignKey<ConductorSnapshotRecord, RbReadyTypeRecord> CONDUCTOR_SNAPSHOT__FK_CONDUCTOR_SNAPSHOT_TBL_READY_TYPE_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_RB_READY_TYPE_TBL, ConductorSnapshot.CONDUCTOR_SNAPSHOT, "conductor_snapshot__fk_conductor_snapshot_tbl_ready_type_id", ConductorSnapshot.CONDUCTOR_SNAPSHOT.READY_TYPE_ID);
        ...
        public static final ForeignKey<DriverRecord, EmployeeDataRecord> DRIVER__FK_DRIVER_TBL_EMPLOYEE_DATA_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_EMPLOYEE_DATA_TBL, Driver.DRIVER, "driver__fk_driver_tbl_employee_data_id", Driver.DRIVER.EMPLOYEE_DATA_ID);
        ...
        public static final ForeignKey<DriverRecord, RbReadyTypeRecord> DRIVER__FK_DRIVER_TBL_READY_TYPE_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_RB_READY_TYPE_TBL, Driver.DRIVER, "driver__fk_driver_tbl_ready_type_id", Driver.DRIVER.READY_TYPE_ID);
        ...
        public static final ForeignKey<DriverSnapshotRecord, EmployeeDataRecord> DRIVER_SNAPSHOT__FK_DRIVER_SNAPSHOT_TBL_EMPLOYEE_DATA_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_EMPLOYEE_DATA_TBL, DriverSnapshot.DRIVER_SNAPSHOT, "driver_snapshot__fk_driver_snapshot_tbl_employee_data_id", DriverSnapshot.DRIVER_SNAPSHOT.EMPLOYEE_DATA_ID);
        ...
        public static final ForeignKey<DriverSnapshotRecord, RbReadyTypeRecord> DRIVER_SNAPSHOT__FK_DRIVER__SNAPSHOT_TBL_READY_TYPE_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_RB_READY_TYPE_TBL, DriverSnapshot.DRIVER_SNAPSHOT, "driver_snapshot__fk_driver__snapshot_tbl_ready_type_id", DriverSnapshot.DRIVER_SNAPSHOT.READY_TYPE_ID);
        ...
        public static final ForeignKey<EmployeeDataRecord, RbEmployeeTypeRecord> EMPLOYEE_DATA__FK_EMPLOYEE_DATA_EMPLOYEE_TYPE_ID = Internal.createForeignKey(ru.smartsarov.bus.postgres.Keys.PK_RB_EMPLOYEE_TYPE_TBL, EmployeeData.EMPLOYEE_DATA, "employee_data__fk_employee_data_employee_type_id", EmployeeData.EMPLOYEE_DATA.EMPLOYEE_TYPE_ID);
